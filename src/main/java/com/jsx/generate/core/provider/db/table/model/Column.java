...
package com.jsx.generate.core.provider.db.table.model;

import java.util.List;

import com.jsx.generate.core.GeneratorProperties;
import com.jsx.generate.core.provider.db.table.model.ForeignKey.ReferenceKey;
import com.jsx.generate.core.provider.db.table.model.util.ColumnHelper;
import com.jsx.generate.core.util.GLogger;
import com.jsx.generate.core.util.StringHelper;
import com.jsx.generate.core.util.TestDataGenerator;
import com.jsx.generate.core.util.typemapping.ActionScriptDataTypesUtils;
import com.jsx.generate.core.util.typemapping.DatabaseDataTypesUtils;
import com.jsx.generate.core.util.typemapping.JavaPrimitiveTypeMapping;
...
public class Column implements java.io.Serializable, Cloneable {
    ...
    /**
     * 得到简短的javaType的名称，如com.company.entity.UserInfo,将返回 UserInfo
     * 
     * @return
     */
     ...
     * 如com.company.entity.UserInfo,将返回 com.company.entity.UserInfo
     * 
     * @return
     */
